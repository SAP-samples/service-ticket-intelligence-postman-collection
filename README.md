...
---------------------
In every new release, these files need to be updated with the new improvements and features. Code lines might need to be added or removed, but the main sample code structure and scope remain the same. 
License:
---------------------
